...
describe("Test GET requests to API", function() {
    describe("what=user_info", function() {
    ...
    describe("what=questions", function() {
    ...
    describe("what=course_pairings", function() {
    ...
    describe("what=surveys", function() {
        ...
        it("should return all surveys related to Hame23", async function() {
            ...
            expect(fetchedJSON.TYPE).to.equal("survey_package");
            assert.isAtLeast(
                fetchedJSON.DATA.length,
                1,
                "Hamed has greater or equal to 1 surveys"
            );
        });
    ...
    describe("what=survey_results", function() {
        it("should return the Crafted survey_instance related to Hame23", async function() {
            let query_string = generate_query_string({
                what: "survey_results",
                user_id: "Hame23",
                target_ta: "Hame23"
            ...
            expect(fetchedJSON).to.have.nested.property("DATA");
            expect(fetchedJSON.TYPE).to.equal("survey_package");
            expect(fetchedJSON.DATA.length).to.equal(1);
        });

        it("should return survey_package for user butler84", async function() {
            let query_string = generate_query_string({
                what: "survey_results",
                user_id: "butler84",
                target_ta: "butler84"
        ...
        it("should return survey_package for user butler84, for term 201809", async function() {
            let query_string = generate_query_string({
                what: "survey_results",
                user_id: "butler84",
                target_ta: "butler84",
        ...
        it("should return survey_package for user butler84 with term 201809 and course UofT", async function() {
            let query_string = generate_query_string({
                what: "survey_results",
                user_id: "butler84",
                target_ta: "butler84",
        ...
        it("should return survey_package for user butler84 with null term and course", async function() {
            let query_string = generate_query_string({
                what: "survey_results",
                user_id: "butler84",
                target_ta: "butler84",
