...
describe("Test POST/UPDATE/DELETE requests to API", function() {
    describe("Test survey setting", function() {
        it("branch survey with survey_id = 1", async function() {
            ...
            let fetched = await fetch(
                "http://localhost:3000/post_info.php?what=surveys&user_id=woods13&level=dept&survey_id=1&action=branch&post_body=base64:" +
                    post_body
            );
        ...
        it("update survey with survey_id = 1 (purely update a current survey)", async function() {
            ...
            let post_body = base64.encode(body);
            let fetched = await fetch(
                "http://localhost:3000/post_info.php?what=surveys&user_id=admin0&level=dept&survey_id=1&action=add_or_update&post_body=base64:" +
                    post_body
            );
            expect(fetched).to.have.status(200);
        });
        ...
        it("update survey with survey_id = 1 (branch first and then update)", async function() {
            ...
            let post_body = base64.encode(body);
            let fetched = await fetch(
                "http://localhost:3000/post_info.php?what=surveys&user_id=prof3&level=course&survey_id=1&action=add_or_update&post_body=base64:" +
                    post_body
            );
            expect(fetched).to.have.status(200);
        });
        ...
        it("send data package with only time setting attributes to the 'update survey setting' API", async function() {
            ...
            let post_body = base64.encode(body);
            let fetched = await fetch(
                "http://localhost:3000/post_info.php?what=surveys&survey_id=1&user_id=butler84&level=section&action=add_or_update&post_body=base64:" +
                    post_body
            );
            expect(fetched).to.have.status(200);
        ...
        it("delete survey with survey_id = 2", async function() {
            ...
            let post_body = base64.encode(body);
            let fetched = await fetch(
                "http://localhost:3000/post_info.php?what=surveys&user_id=admin0&level=dept&survey_id=2&action=delete&post_body=base64:" +
                    post_body
            );
            expect(fetched).to.have.status(200);
        });
    ...
    describe("Test updating courses and sections", function() {
        it("add a section for a course", async function() {
            ...
            let post_body = base64.encode(body);
            let fetched = await fetch(
                "http://localhost:3000/post_info.php?what=course_pairings&user_id=admin0&mode=courses_sections&action=add_or_update&post_body=base64:" +
                    post_body
            );
            expect(fetched).to.have.status(200);
            let fetchedJSON = await fetched.json();
        ...
        */
        ...
        it("delete a course and its related sections", async function() {
            ...
            let fetched = await fetch(
                "http://localhost:3000/post_info.php?what=course_pairings&user_id=admin0&mode=courses_sections&action=delete&post_body=base64:" +
                    post_body
            );
            expect(fetched).to.have.status(200);
            let fetchedJSON = await fetched.json();
